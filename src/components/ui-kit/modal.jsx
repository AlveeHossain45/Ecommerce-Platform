...
import { X, Maximize2, Minimize2, Download, Share, ExternalLink } from 'lucide-react'
    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        ...
        >
          ...
          >
            {/* Header */}
            {(showHeader && (title || showCloseButton || actions)) && (
              <div className={clsx(
                    ...
                    >
                      {actions.map((action, index) => (
                        ...
                        >
                          ...
                          {action.icon === 'external' && <ExternalLink size={18} />}
                        </motion.button>
                      ))}
                    </motion.div>
                  )}
...
<Modal
  ...
  actions={[
    ...
    { label: 'Save', onClick: handleSave, variant: 'primary', footer: true },
    { label: 'Cancel', onClick: handleClose, variant: 'default', footer: true }
  ]}
>
  <div className="space-y-4">
    <p>Premium modal content with gradient background and enhanced styling.</p>
  </div>
</Modal>
